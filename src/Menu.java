...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(133, 20, 280, -1));
        ...
        buttonGroup1.add(IP);
        IP.setFont(new java.awt.Font("Copperplate Gothic Bold", 0, 18)); // NOI18N
        IP.setForeground(new java.awt.Color(255, 255, 0));
        IP.setText("Information Technology");
        IP.setOpaque(false);
        ...
        getContentPane().add(IP, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 140, 300, 60));

        GK.setBackground(new java.awt.Color(248, 246, 244));
        buttonGroup1.add(GK);
        GK.setFont(new java.awt.Font("Copperplate Gothic Bold", 1, 18)); // NOI18N
        GK.setForeground(new java.awt.Color(255, 255, 0));
        GK.setText("Gernal Knowledge");
        GK.setOpaque(false);
        ...
        getContentPane().add(GK, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 220, 260, -1));

        startTestBTN.setBackground(new java.awt.Color(204, 153, 0));
        startTestBTN.setFont(new java.awt.Font("Copperplate Gothic Bold", 0, 18)); // NOI18N
        ...
        getContentPane().add(startTestBTN, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 290, 180, 40));

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(102, 0, 102));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/abstract-network-science-connection-technology_36402-247.jpg"))); // NOI18N
